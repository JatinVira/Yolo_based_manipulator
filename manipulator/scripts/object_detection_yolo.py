...
then find the color and name of the object and publish it to a topic to control the Arm
"""
...
class ObjectDetection:
    """
    A class to detect objects in an image and publish the color of the object to a topic
    """
